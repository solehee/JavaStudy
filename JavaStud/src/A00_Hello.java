...
/*
 	...
 	- End : 줄의 맨 뒤로 이동
 	- Shift + End : 현재 커서 위치부터 줄의 맨 뒤까지 블록 지정
 	- Tab : 들여쓰기
 	- Shift + Tab : 역으로 들여쓰기
 	- Ctrl + Shift + F : 자동으로 들여쓰기 맞춤
 	- Ctrl + w : 보고 있는 창 닫기
 	- Ctrl + Shift + w : 보고 있는 창 모두 닫기
	...
	*/
	public static void main(String[] args) {
		...
		/*
			...
			- ()안에 전달한 데이터를 콘솔에 출력하는 함수
		 	...
		 	- 이클립스에서 Ctrl + F11을 누르면 우리가 만든 프로그램을
		 	  테스트용 콘솔에서 실행해볼 수 있다
		 	- 우리가 만튼 소스코드(.java)의 컴파일 결과물(.class)은
		 	  bin폴더에 저장되어 있다
		...
		*/
		...
		// * 문자열과 정수의 차이
		System.out.println(12345689 + 10);
		System.out.println("123456789" + 10);
		
		System.out.println(123.12345 + 0.03333);
