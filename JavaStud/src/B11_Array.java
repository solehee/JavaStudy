...
public class B11_Array {
	...
	*/
	public static void main(String[] args) {
		...
		System.out.println("첫번째 스캐너"+scanners[0]);
		System.out.println("두번째 스캐너"+scanners[1]);
		System.out.println("세번째 스캐너"+scanners[2]);
		System.out.println("네번째 스캐너"+scanners[3]);
		...
		System.out.println("scanner의 길이 : "+scanners.length);
		System.out.println("scanner의 마지막 인덱스 번호 : "+(scanners.length-1));
