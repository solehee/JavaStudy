...
public class D11_Time {
	/*
	 	# java.time 패키지
	 	- Calendar 클래서에서 set()을 하면 원본 인스턴스가 변해버린다는 단점을 보완한 클래스
	...
	*/
	public static void main(String[] args) {
		...
		LocalDate before100years = now.minusYears(1000);
		
		System.out.println(now);
		System.out.println(after3years);
		System.out.println(before100years.getDayOfWeek());
		
		// 시간을 문자열로 변경하기
		DateTimeFormatter my_date_format = DateTimeFormatter.ofPattern("y년 M월 d일 E요일");
		String message = my_date_format.format(before100years);
