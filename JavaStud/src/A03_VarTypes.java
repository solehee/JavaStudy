...
public class A03_VarTypes {
	...
	public static void main(String[] args){
		...
		/*
		 	...
		 	# 정수 타입
		 	 - byte 	(1byte) -128 ~ +127 
		 	  ...
		 	  byte타입의 양수 범위 0000 0000 ~ 0111 1111
		 	  byte타입의 음수 범위 1000 0000(-128) ~ 1111 1111(-1) 
		 	 
		 	 
		 	 - short 	(2byte) -32768 ~ +32767
		 	 - char 	(2byte unsigned) 0 ~ 65535	※ 문자 코드 저장용
		...
		*/
		...
		// int타입의 범위를 벗어나느 값을 사용하고 싶다면 뒤에 ㅣ 또는 L을 붙어야 한다.
		...
		*/
		...
		// char 타입은 문자코드를 저장용 정수 타입이다
		char ch = 120;
		char ch2 = 'x';
		int num1 = 'x';
		
		System.out.println("ch에 저장된 값: "+ ch);
		System.out.println("'x'에 저장한 char타입 변수의 출력: "+ ch2);
		System.out.println("'x'에 저장한 int타입 변수의 출력: "+ num1);
