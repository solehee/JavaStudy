...
public class C12_InnerClass {
	...
	/*
	 	...
	 	- 클래스 내부에 존재하는 클래스는 바깥쪽 클래스의 인스턴스가 존재해야 사용 할 수 있다
...
class MintChocoLatte{
	...
	/**
	     내부의 인스턴스 클래스는 MintChocoLatte의 인스턴스가 존재해야 함께 생성되는 설계도이다.
	...
	*/
	class Chocolate {
		...
		public Chocolate() {
			if(hot) {
				System.out.println("초코 다 녹음");
			}else {
				System.out.println("초코 잘 안녹");
			}
		}
	}
